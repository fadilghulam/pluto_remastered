...
type TokenFcm struct {
	...
	CreatedAt         string  `gorm:"column:created_at;not null;default:now()" json:"createdAt"`
	UpdatedAt         string  `gorm:"column:updated_at;not null;default:now()" json:"updatedAt"`
	DeletedAt         *string `gorm:"column:deleted_at;default:null" json:"deletedAt"`
