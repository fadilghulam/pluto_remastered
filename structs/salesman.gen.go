...
type Salesman struct {
	...
	DtmCrt               time.Time  `gorm:"column:dtm_crt;not null;default:(now() + '12:00:00" json:"dtm_crt"`
	DtmUpd               time.Time  `gorm:"column:dtm_upd;not null;default:(now() + '12:00:00" json:"dtm_upd"`
	...
	AksesRetur           time.Time  `gorm:"column:akses_retur" json:"akses_retur"`
	AksesKredit          time.Time  `gorm:"column:akses_kredit" json:"akses_kredit"`
	...
	AksesDoubleTransaksi time.Time  `gorm:"column:akses_double_transaksi" json:"akses_double_transaksi"`
	...
	AksesKreditNoo       time.Time  `gorm:"column:akses_kredit_noo" json:"akses_kredit_noo"`
	...
	IgnorePlafonAccess   time.Time  `gorm:"column:ignore_plafon_access;default:2024-12-31 20:00:00" json:"ignore_plafon_access"`
}
