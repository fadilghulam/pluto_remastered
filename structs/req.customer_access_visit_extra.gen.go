...
const TableNameCustomerAccessVisitExtra = "customer_access_visit_extra"

// CustomerAccessVisitExtra mapped from table <customer_access_visit_extra>
type CustomerAccessVisitExtra struct {
	...
	AccessType  string         `gorm:"column:access_type;not null;default:VISIT EXTRA" json:"access_type"`
...
// TableName CustomerAccessVisitExtra's table name
func (*CustomerAccessVisitExtra) TableName() string {
	return TableNameCustomerAccessVisitExtra
}
