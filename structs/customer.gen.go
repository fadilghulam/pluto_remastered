...
type Customer struct {
	...
	ImageToko               *string        `gorm:"column:image_toko;default:null" json:"image_toko"`
	...
	FrekKunjungan           *string        `gorm:"column:frek_kunjungan;default:null" json:"frek_kunjungan"`
	...
	AksesDoubleKredit       *string        `gorm:"column:akses_double_kredit;default:null" json:"akses_double_kredit"`
	TanggalVerifikasi       *string        `gorm:"column:tanggal_verifikasi" json:"tanggal_verifikasi"`
	...
	VisitExtra              *string        `gorm:"column:visit_extra" json:"visit_extra"`
	...
	DateLastTransaction     *string        `gorm:"column:date_last_transaction" json:"date_last_transaction"`
	DateLastVisitBySalesman *string        `gorm:"column:date_last_visit_by_salesman" json:"date_last_visit_by_salesman"`
	...
	*/
	...
	IsCountInsentif    *int16       `gorm:"column:is_count_insentif;default:1" json:"is_count_insentif"`
	PlafonOverNominal  *float64     `gorm:"column:plafon_over_nominal" json:"plafon_over_nominal"`
	PlafonOverAccess   *string      `gorm:"column:plafon_over_access" json:"plafon_over_access"`
	CustomerIDs        *StringArray `gorm:"column:customer_ids" json:"customer_ids"`
	UserIDHolder       *int32       `gorm:"column:user_id_holder" json:"user_id_holder"`
	KategoriCustomerID *int16       `gorm:"column:kategori_customer_id" json:"kategori_customer_id"`
	IsRecommendation   *int16       `gorm:"column:is_recommendation" json:"is_recommendation"`
}
