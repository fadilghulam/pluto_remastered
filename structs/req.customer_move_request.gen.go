...
const TableNameCustomerMoveRequest = "customer_move_request"
...
type CustomerMoveRequest struct {
	...
	SalesmanIDSource      *string        `gorm:"column:salesman_id_source;default:null" json:"salesman_id_source"`
	SalesmanIDDestination *int32         `gorm:"column:salesman_id_destination;default:null" json:"salesman_id_destination"`
...
func (*CustomerMoveRequest) TableName() string {
	return TableNameCustomerMoveRequest
}
